...
urlpatterns = [
    ...
    path('api/login/email/', LoginWithEmailView.as_view(), name='login-email'),
    path('api/login/iin/', LoginWithIINView.as_view(), name='login-iin'),
    path('api/upload/', ExcelUploadView.as_view(), name='upload-excel'),
    ...
    path("api/buildings/<uuid:building_id>/report/", download_building_report, name="download_report"),
    path('api/buildings/reports/', get_report_history, name='report_history'),
