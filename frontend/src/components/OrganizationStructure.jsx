          ...
          <div className="flex flex-col lg:flex-row gap-10 items-center">
            ...
            <div className="space-y-6 max-w-[756px] text-[20px] leading-relaxed font-montserrat text-left">
              ...
              <p className="font-bold">
                Товарищество с ограниченной ответственностью “Горкомхоз Модернизация жилья” занимается организацией и реализацией проектов по модернизации жилищного фонда. Основная цель предприятия — улучшение состояния жилых домов, повышение их энергоэффективности и продление срока эксплуатации зданий.
              </p>
            </div>
          </div>
        </div>
