  ...
  return (
    <div className="font-sans text-white bg-[#121212]">
      ...
      >
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 max-w-6xl w-full">
            <div className="bg-white text-black rounded-xl p-4 text-sm shadow-md">
            ...
            <div className="bg-sky-500 text-white rounded-xl p-4 text-sm shadow-md">
      ...
      <section className="flex flex-col md:flex-row justify-center gap-4 px-6 pb-12">
        <button className="bg-black text-white py-3 px-6 rounded-full font-semibold shadow">О деятельности</button>
        <button className="bg-black text-white py-3 px-6 rounded-full font-semibold shadow">Структура организации</button>
        <button className="bg-black text-white py-3 px-6 rounded-full font-semibold shadow">Завершенные объекты</button>
      </section>
