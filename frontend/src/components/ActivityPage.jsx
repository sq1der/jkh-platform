    ...
    <div className="text-black">
      ...
      <header
        ...
        <div className="relative z-10 max-w-6xl w-full flex flex-col md:flex-row items-center gap-10">
            ...
            <p>
                <span className="font-bold">Наша ключевая задача</span> — модернизация жилищного фонда и инфраструктуры, а также внедрение современных цифровых решений для упрощения взаимодействия между поставщиками коммунальных услуг, подрядными организациями и государственными структурами.
            </p>
            </div>
        </div>
      </header>
